...
{    
	...
	{
        $query = "INSERT INTO addforms SET formtitle=:formtitle, file=:file, type=:type,size=:size";
        $stmt = $db_con->prepare($query);
        $stmt->bindParam(":formtitle", $formname);
        ...
        $success= "New Form Record created."; 
    }else{
        $failure= "Unable to create New Form Record.";
    }
                ...
                <div class="advforms">
                    ...
                    <form method="post" action="addForm.php" enctype="multipart/form-data">
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                            <input type="text" class="ftxt" name="ftitle">
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-sm-6">Upload:*</div>
                            <div class="col-sm-6">
                            <input type="file" class="ftxt" name="mfileto">
                            </div>
                        </div>
